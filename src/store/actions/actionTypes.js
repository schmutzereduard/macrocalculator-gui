...
export const FETCH_DAY_JOURNAL_REQUEST = 'FETCH_DAY_JOURNAL_REQUEST';
export const FETCH_DAY_JOURNAL_SUCCESS = 'FETCH_DAY_JOURNAL_SUCCESS';
export const FETCH_DAY_JOURNAL_FAIL = 'FETCH_DAY_JOURNAL_FAIL';

export const FETCH_MONTH_JOURNALS_REQUEST = 'FETCH_MONTH_JOURNALS_REQUEST';
export const FETCH_MONTH_JOURNALS_SUCCESS = 'FETCH_MONTH_JOURNALS_SUCCESS';
export const FETCH_MONTH_JOURNALS_FAIL = 'FETCH_MONTH_JOURNALS_FAIL';
...
export const SHOW_SAVE_FOOD_CHANGES_MODAL = 'SHOW_SAVE_FOOD_CHANGES_MODAL';
export const HIDE_SAVE_FOOD_CHANGES_MODAL = 'HIDE_SAVE_FOOD_CHANGES_MODAL';
...
export const SHOW_SAVE_RECIPE_CHANGES_MODAL = 'SHOW_SAVE_RECIPE_CHANGES_MODAL';
export const HIDE_SAVE_RECIPE_CHANGES_MODAL = 'HIDE_SAVE_RECIPE_CHANGES_MODAL';

export const SHOW_EDIT_JOURNAL_MODAL = 'SHOW_EDIT_JOURNAL_MODAL';
export const HIDE_EDIT_JOURNAL_MODAL = 'HIDE_EDIT_JOURNAL_MODAL';

export const SHOW_DELETE_JOURNAL_MODAL = 'SHOW_DELETE_JOURNAL_MODAL';
export const HIDE_DELETE_JOURNAL_MODAL = 'HIDE_DELETE_JOURNAL_MODAL';

export const SHOW_SAVE_JOURNAL_CHANGES_MODAL = 'SHOW_SAVE_JOURNAL_CHANGES_MODAL';
export const HIDE_SAVE_JOURNAL_CHANGES_MODAL = 'HIDE_SAVE_JOURNAL_CHANGES_MODAL';